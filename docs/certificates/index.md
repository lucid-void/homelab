...
One token, shared by all four consumers.

- **Scope:** Zone → DNS → Edit, restricted to `blackcats.cc`
- **Delivery:** Traefik receives it as a Docker secret; Proxmox, PBS, and TrueNAS receive it via Ansible
