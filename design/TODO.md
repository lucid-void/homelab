...
| **playit.gg** | _Not needed._ Tunnel service for exposing game servers without port forwarding — but remote access is already Netbird-gated by design, and mc-router publishes the servers internally at `172.16.20.52:25565`. Would only apply if servers were ever opened to non-VPN players |
